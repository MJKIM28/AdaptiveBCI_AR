...
% %%%%%%%%%%%%%% Only Testing%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
prompt = {'IP address:','Port number:','Subject number:','Classifier mode:','Fusion mode:'};
dlgtitle = 'Input';
fieldsize = [1 45; 1 45; 1 45; 1 45; 1 45];
definput = {'127.0.0.1','1668','Sub01','adaptive','fusion'};
                ...
                case 4       % 32Bit Data block
                    ...
                    if param.switch_on %
                        ...
                        switch param.trD.mode
                            case 'testing'
                                [C, param] = P300_processing_adaptive_new(sig_vec(1:param.NumChIni,:),trigger_re,param);
...
%                                 shareVar.value = C;
                                ...
                                save([param.dir,'/param',num2str(param.Numtrial)],'param'); % save parameter
