...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%% Training %%%%%%%%%%%%%%%%%%%%%%
fprintf('ARm uses the minimum number of channels (22)\n')
InitVer = input('Init. version (Def/AR/ARm):','s');
param = Initialization(InitVer);
fprintf('Initialization for ver.%s\n',InitVer);
...
param.MW.Windowlength = fix(0.2 * param.Fs);
param.MW.Windowlist = fix(1: 0.05 * param.Fs : param.Epocline - param.MW.Windowlength);
param.MW.Ntime = length(param.MW.Windowlist);
param.MW.kfold = 3;
